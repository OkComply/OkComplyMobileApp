...
class AccordionGepland extends Component {
	constructor(props) {
		super(props);
		this.state = {
			data: taskData,
...
function mapDispatchToProps(dispatch){
	return {
		setActive: (expanded2) => dispatch({type:'IS_ACTIVE2', payload:expanded2})
...
export default connect(null,mapDispatchToProps)(AccordionGepland)